...
function Footer() {
  return (
    <div className="Footer text-white container p-4">
      <h2 className="mb-5">شرکت شما سزاوار این برتری است. بیایید صحبت کنیم</h2>
      ...
      <p className="text-center">
        <p>
          © <strong>حسام کدر </strong>. تمام حقوق قالب محفوظ است. طراحی و توسعه
          توسط
          <a
            className="text-orange"
            href="https://t.me/Programe_Developer"
            target="_blank"
          >
            Hesam Okati
          </a>
